...
class AM_MT_DataUtilPie(Menu):
    ...
    def draw(self, context):
        ...
        row.scale_y = 1.5
        box.operator("amblender.du_set_diffuse_image_scale_4096")
        ...
        box.operator("amblender.du_set_diffuse_image_scale_128")
        box.operator("amblender.du_set_diffuse_image_scale_64")
        box.separator()
        box.operator("amblender.du_set_normal_image_scale_4096")
        ...
        box.operator("amblender.du_set_normal_image_scale_128")
        box.operator("amblender.du_set_normal_image_scale_64")
        box.separator()
        box.operator("amblender.du_set_rough_metallic_occ_image_scale_4096")
        ...
        box.separator()
        box.operator("amblender.du_set_emission_image_scale_4096")
        box.operator("amblender.du_set_emission_image_scale_2048")
        box.operator("amblender.du_set_emission_image_scale_1024")
        box.operator("amblender.du_set_emission_image_scale_512")
        box.operator("amblender.du_set_emission_image_scale_256")
        box.operator("amblender.du_set_emission_image_scale_128")
        box.operator("amblender.du_set_emission_image_scale_64")

        # R
        box = pie.split().column()
        row = box.row(align=True)
        row.scale_y = 1.5
        box.operator("amblender.du_copy_textures_to_export_dir")
        box.operator("amblender.du_unpack_images")
        box.operator("amblender.du_unpack_all_images")
