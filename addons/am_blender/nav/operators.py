...
class AM_Nav_Workspace_Modeling(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.workspace(WorkSpaceId.Modeling)
        return {'FINISHED'}
...
class AM_Nav_Workspace_UV_Editing(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.workspace(WorkSpaceId.UVEditing)
        return {'FINISHED'}
...
class AM_Nav_Workspace_Layout(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.workspace(WorkSpaceId.Layout)
        return {'FINISHED'}
...
class AM_Nav_Workspace_Sculpting(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.workspace(WorkSpaceId.Sculpting)
        return {'FINISHED'}
...
class AM_Nav_Workspace_Texture_Paint(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.workspace(WorkSpaceId.TexturePaint)
        return {'FINISHED'}
...
class AM_Nav_Workspace_Shading(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.workspace(WorkSpaceId.Shading)
        return {'FINISHED'}
...
class AM_Nav_Workspace_Rendering(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.workspace(WorkSpaceId.Rendering)
        return {'FINISHED'}
...
class AM_Nav_Workspace_Assets(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.workspace(WorkSpaceId.Assets)
        return {'FINISHED'}
...
class AM_Nav_Workspace_Geometry_Nodes(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.workspace(WorkSpaceId.GeometryNodes)
        return {'FINISHED'}
...
class AM_Nav_Workspace_Scripting(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.workspace(WorkSpaceId.Scripting)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_Tool(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.TOOL)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_Render(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.RENDER)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_Output(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.OUTPUT)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_View_Layer(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.VIEW_LAYER)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_Scene(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.SCENE)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_World(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.WORLD)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_Collection(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.COLLECTION)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_Object(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.OBJECT)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_Modifier(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.MODIFIER)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_Particles(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.PARTICLES)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_Physics(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.PHYSICS)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_Constraint(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.CONSTRAINT)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_Data(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.DATA)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_Material(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.MATERIAL)
        return {'FINISHED'}
...
class AM_Nav_Properties_Tab_Texture(bpy.types.Operator):
    ...
    def execute(self, context):
        ui.nav.properties_tab(PropertiesTab.TEXTURE)
        return {'FINISHED'}
