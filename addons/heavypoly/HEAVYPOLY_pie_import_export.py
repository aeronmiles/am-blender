...
class HP_MT_pie_importexport(Menu):
    ...
    def draw(self, context):
        ...
        # box.operator('import_scene.dae', text='Import DAE')
        box.operator('import_scene.gltf', text='Import GLTF')
        box.operator('import.usdz', text='Import USDZ')
        ...
        # # box.operator('export_scene.dae', text='Export DAE')
        box.operator('export_scene.gltf', text='Export GLTF')
        box.operator('export.usdz', text='Export USDZ')
